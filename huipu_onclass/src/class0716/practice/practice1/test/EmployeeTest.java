package class0716.practice.practice1.test;
import class0716.practice.practice1.dao.EmployeeDao;
        ...
        out1:
        {
            while (true) {
                ...
                if (index == 1) {
                    ...
                    System.out.println("请输入您的部门：");
                    String department = sc.nextLine();

                    dao.addEmployee(name,age,sex,department);
